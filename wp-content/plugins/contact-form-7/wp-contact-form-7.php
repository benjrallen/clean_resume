<?php
/*
Plugin Name: HTML5 Contact Form 7
Plugin URI: http://contactform7.com/
Description: Just another contact form plugin. Simple but flexible. Now with HTML5 support.
Author: Takayuki Miyoshi, HTML5 mod by Jack Smith
